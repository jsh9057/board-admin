...
import com.jsh.boardadminproject.dto.security.BoardAdminPrincipal;
import com.jsh.boardadminproject.dto.security.KakaoOAuth2Response;
...
public class SecurityConfig {
     ...
     *
     * <p>
     * TODO: 카카오 도메인에 결합되어 있는 코드. 확장을 고려하면 별도 인증 처리 서비스 클래스로 분리하는 것이 좋지만, 현재 다른 OAuth 인증 플랫폼을 사용하지 않을것이라 이렇게 사용 함.
     *
     * @param adminAccountService 게시판 서비스의 자용자 계정을 다루는 서비스 로직
